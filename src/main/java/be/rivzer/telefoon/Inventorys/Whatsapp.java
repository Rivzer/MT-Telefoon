...
public class Whatsapp {
    ...
    public static void OpenTelefoonWhatsapp(Player p){
        Inventory inv = Bukkit.createInventory(p, InventoryType.SHULKER_BOX, Logger.color("&0."));

        setItem(inv, Material.IRON_INGOT, 3, "&a&lMaak Nieuw Bericht", "nieuwbericht");

        setItem(inv, Material.IRON_INGOT, 2, "&a&lBerichten", "berichten");
