...
public class ING {
    ...
    public static void OpenTelefoonING(Player p){
        Inventory inv = Bukkit.createInventory(p, InventoryType.SHULKER_BOX, Logger.color("&0."));

        setItem(inv, Material.IRON_INGOT, 2, "&6&lMaak Nieuwe Transactie", "ingnew");

        setItem(inv, Material.IRON_INGOT, 3, "&6&lTransactie History", "inghistory");
