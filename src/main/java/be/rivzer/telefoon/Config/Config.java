package be.rivzer.telefoon.Config;
...
public class Config {
    ...
    public static void saveConfig1() {
        File file = new File("plugins//Telefoon//config.yml");
        try {
    ...
    public static void saveConfig2() {
        File file = new File("plugins//Telefoon//data.yml");
        try {
    ...
    public static void saveConfig3() {
        File file = new File("plugins//Telefoon//language.yml");
        try {
